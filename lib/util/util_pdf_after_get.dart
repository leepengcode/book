// ignore_for_file: unused_local_variable, deprecated_member_use, prefer_const_constructors, unnecessary_string_interpolations
...
class _MyPDFState_api extends State<MyPDF_api> {
  ...
  Future<Uint8List> generatePdf(
    ...
    final ByteData border =
        await rootBundle.load('assets/images/border_PDF.png');
    final Uint8List layoutborder = border.buffer.asUint8List();
    final ByteData Cover = await rootBundle.load('assets/images/D_Cover.jpg');
    final Uint8List layoutCover = Cover.buffer.asUint8List();
    Uint8List? layoutImage;

    final pageTheme = await _myPageTheme(format);
    final font = await PdfGoogleFonts.robotoBlack();
    final h_font = await PdfGoogleFonts.robotoBlack();
    final b_font = await PdfGoogleFonts.robotoBlack();
    final khmer = await PdfGoogleFonts.robotoBlack();
...
//style
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (context) => [
        pw.Container(
            ...
            child: pw.Image(pw.MemoryImage(layoutCover),
    ...
    pdf.addPage(
      pw.MultiPage(
        // pageTheme: pageTheme,
        maxPages: 1, margin: pw.EdgeInsets.all(0.4),
        pageFormat: PdfPageFormat.a4,
        build: (context) => [
          //  pw.Column(
          ...
          pw.Container(
            ...
            margin:
                const pw.EdgeInsets.only(top: 25, right: 25), // Add margin here
            child: pw.Text(
          ...
          pw.Container(
            height: 730,
            margin: const pw.EdgeInsets.only(top: 5, left: 40, right: 25),
            decoration: pw.BoxDecoration(
                ...
                image: pw.DecorationImage(
                    image: pw.MemoryImage(layoutborder), fit: pw.BoxFit.fill)),
            child: pw.Center(
                child: pw.Column(
              ...
              children: [
                ...
                pw.Padding(
                    ...
                    child: pw.Image(pw.MemoryImage(widget.set_objCover_image),
                        fit: pw.BoxFit.cover, height: 280)),
                pw.Padding(
                  padding:
                      const pw.EdgeInsets.only(top: 15, right: 50, left: 60),
                  child: pw.RichText(
                      text: pw.TextSpan(
                        text: 'Address :',
                        style: header2(false), // Base style
                ...
                pw.Padding(
                  padding: const pw.EdgeInsets.only(top: 5), // Add margin here
                  child: pw.RichText(
                    text: pw.TextSpan(
    ...
    pdf.addPage(
      pw.MultiPage(
                  ...
                  children: [
                    ...
                    if (widget.objCover!.header ==
                      ...
                      pw.Text(
                        ...
                        widget.objCover!.header ==
                            "Property OFFICE SPACE VALUATION REPORT" &&
                        widget.objCover!.header == "Property CONDO REPORT") ...[
                      pw.Text(
                          "\nLand Layout .......................................................................................................................................... - 5 -",
                          style: body(),
                          textAlign: pw.TextAlign.center),
        ...
        //   margin: pw.EdgeInsets.only(top: 10.0),
        //   child: pw.Text(
        //     'Page ${context.pageNumber-4} of ${context.pagesCount}',
        //     style: pw.TextStyle(fontSize: 12, color: PdfColors.grey),
        //   ),
        // ),
      ),
            ...
            child: pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("\nPurpose Of Appraisal", style: header2(true)),
                    pw.Text(
                    ...
                    pw.Text(
                        ...
                        style: body1()),
                    pw.Text("\nMarket Comparison Method", style: header2(true)),
                    pw.Container(
                      child: pw.RichText(
                        text: pw.TextSpan(
                          text:
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.Container(
          height: 750,
          // margin:
          //     const pw.EdgeInsets.only(top: 5, left: 40, right: 25, bottom: 25),
          decoration: pw.BoxDecoration(
              // border: pw.Border.all(
              //   color: PdfColors.black,
              //   width: 1, // Adjust border width as needed
      ...
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Container(
            ...
            alignment: pw.Alignment.topCenter,
            margin: const pw.EdgeInsets.only(
                top: 15, left: 40, right: 40, bottom: 50),
            decoration: pw.BoxDecoration(
                // border: pw.Border.all(
                //   color: PdfColors.black,
                //   width: 1, // Adjust border width as needed
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text('Owner’s Identification Card',
                    style: header2(true), textAlign: pw.TextAlign.start),
                pw.SizedBox(height: 10),
                pw.GridView(
                    crossAxisCount: 1,
                    crossAxisSpacing: 6,
                    ...
                    children: [
                      pw.Image(pw.MemoryImage(widget.set_fidcard1),
                          fit: pw.BoxFit.fill, width: 420),
                      pw.Image(pw.MemoryImage(widget.set_bidcard1),
                          fit: pw.BoxFit.fill, width: 420),
          ...
          pw.Container(
            ...
            child: pw.Center(
              ...
              children: [
                pw.Padding(
                    padding:
                        const pw.EdgeInsets.only(top: 25, left: 15, right: 15),
                    child: pw.Column(
                      mainAxisAlignment: pw.MainAxisAlignment.center,
                      children: [
                        if (widget.objCover!.header ==
                        ...
                        pw.GridView(
                            ...
                            childAspectRatio: 0.59,
                            children: [
                              pw.Image(pw.MemoryImage(ownerimg1),
                                  fit: pw.BoxFit.fill, width: 420),
                              pw.Image(pw.MemoryImage(ownerimg2),
                                  fit: pw.BoxFit.fill, width: 420),
                            ])
                      ],
                    ) // Add margin here
      ...
      build: (context) => [
        ...
        pw.Container(
          ...
          child: pw.Center(
              child: pw.Container(
                  padding:
                      const pw.EdgeInsets.only(top: 15, left: 15, right: 15),
                  height: 750,
                  child: pw.Column(
                    mainAxisAlignment: pw.MainAxisAlignment.center,
                    children: [
                              ...
                              pw.Expanded(
                                ...
                                child: pw.Container(
                                  decoration: pw.BoxDecoration(
                                      ...
                                      image: pw.DecorationImage(
                                          image: pw.MemoryImage(map2Image),
                                          fit: pw.BoxFit.fitHeight)),
                                ),
                              ),
                            ])),
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Container(
                              ...
                              decoration: pw.BoxDecoration(
                                  ...
                                  image: pw.DecorationImage(
                                      image: pw.MemoryImage(map3Image),
                                      fit: pw.BoxFit.fitHeight))))
                    ],
                  ) // Add margin here
                  )),
      ...
      build: (context) => [
        ...
        pw.Container(
          ...
          child: pw.Center(
              child: pw.Padding(
                  padding:
                      const pw.EdgeInsets.only(top: 10, left: 20, right: 20),
                  child: pw.Column(
                    mainAxisAlignment: pw.MainAxisAlignment.start,
                    crossAxisAlignment: pw.CrossAxisAlignment.center,
                    children: [
                      ...
                      if (widget.objCover!.header ==
                        ...
                        pw.Text('I. Photo front view of the Land',
                          ...
                          "Property OFFICE SPACE VALUATION REPORT") ...[
                        pw.Text('I. Photo front view of the Office Space',
                            style: header2(true),
                            textAlign: pw.TextAlign.start),
                      ] else ...[
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Container(
                          ...
                          decoration: pw.BoxDecoration(
                              ...
                              image: pw.DecorationImage(
                                  image:
                                      pw.MemoryImage(widget.frontviewimage))),
                        ),
                      ),
                      if (widget.objCover!.header ==
                          "Property [LAND AND BUILDING] VALUATION REPORT") ...[
                        pw.Text('II. Photos inside view of the Property',
                            style: header3(), textAlign: pw.TextAlign.start),
                        ...
                        pw.Text('1.Photos view of the Land',
                          ...
                          "Property OFFICE SPACE VALUATION REPORT") ...[
                        pw.Text('II. Photos inside view of the Office Space',
                            style: header3(), textAlign: pw.TextAlign.start),
                        ...
                        if (widget.objCover!.header ==
                          ...
                          pw.Expanded(
                            ...
                            child: pw.GridView(
                                ...
                                children: [
                                  for (var photo
                                      in widget.list_forviewproperty!) ...[
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        if (widget.objCover!.header ==
                          ...
                          pw.Text('II. Photos inside view of the Property',
                              style: header3(), textAlign: pw.TextAlign.start),
                          pw.Text('2.Photos view inside of the Property',
                              style: header3(), textAlign: pw.TextAlign.start),
                        ] else if (widget.objCover!.header ==
                            "Property LAND VALUATION REPORT") ...[
                          pw.Text('II. Photos inside view of the Land',
                          ...
                          pw.Text('II. Photos inside view of the Office Space',
                              style: header3(), textAlign: pw.TextAlign.start),
                          pw.Text('2.Photos view inside of the Office Space ',
                              style: header3(), textAlign: pw.TextAlign.start),
                        ] else ...[
                          pw.Text('II. Photos inside view of the Condo',
                              style: header3(), textAlign: pw.TextAlign.start),
                        ...
                        if (widget.list_forinsideproperty!.length >= 1)
                          pw.Expanded(
                            ...
                            child: pw.GridView(
                                ...
                                children: [
                                  for (var photo
                                      in widget.list_forinsideproperty!) ...[
                                    pw.Image(pw.MemoryImage(photo),
                                        fit: pw.BoxFit.fill),
                                  ]
                                ]),
...
//     //Page Twenty
                    ...
                    children: [
                      if (widget.objCover!.header ==
                        ...
                        pw.Text(
                          ...
                          "Property LAND VALUATION REPORT") ...[
                        pw.Text('III. Photos view of Access Road to the Land',
                            style: header3(), textAlign: pw.TextAlign.start),
                      ] else if (widget.objCover!.header ==
                          "Property OFFICE SPACE VALUATION REPORT") ...[
                        pw.Text(
                        ...
                        pw.Text('III. Photos view of Access Road to the Condo',
                            style: header3(), textAlign: pw.TextAlign.start),
                      ],
                      pw.Expanded(
                        flex: 2,
                        child: pw.Row(
                            ...
                            children: [
                              pw.Image(pw.MemoryImage(widget.roadviewimage1),
                                  height: 150,
                                  width: 700,
                                  fit: pw.BoxFit.contain),
                              pw.Image(pw.MemoryImage(widget.roadviewimage2),
                                  height: 150,
                                  width: 700,
                                  fit: pw.BoxFit.contain),
                            ]),
                      ...
                      if (widget.objCover!.header ==
                          "Property [LAND AND BUILDING] VALUATION REPORT") ...[
                        pw.Text('IV. Photos surroundings view of the Property',
                            style: header3(), textAlign: pw.TextAlign.start),
                      ] else if (widget.objCover!.header ==
                          "Property LAND VALUATION REPORT") ...[
                        pw.Text('IV. Photos surroundings view of the Land',
                            style: header3(), textAlign: pw.TextAlign.start),
                      ] else if (widget.objCover!.header ==
                          "Property OFFICE SPACE VALUATION REPORT") ...[
                        pw.Text(
                        ...
                        pw.Text('IV. Photos surroundings view of the Condo',
                            style: header3(), textAlign: pw.TextAlign.start),
                      ],
                      pw.SizedBox(height: 10),
                      pw.Expanded(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                pw.Column(
                                    ...
                                    children: [
                                      pw.Image(
                                          pw.MemoryImage(widget.surroundin1),
                                          height: 150,
                                          width: 700,
                                          fit: pw.BoxFit.contain),
                                ...
                                pw.Column(
                                    ...
                                    children: [
                                      pw.Image(
                                          pw.MemoryImage(widget.surroundin2),
                                          height: 150,
                                          width: 700,
                                          fit: pw.BoxFit.contain),
                                      pw.SizedBox(height: 2),
                            ...
                            children: [
                              pw.Column(
                                  crossAxisAlignment:
                                      pw.CrossAxisAlignment.center,
                                  children: [
                                    pw.Image(pw.MemoryImage(widget.surroundin3),
                                        height: 150,
                                        width: 700,
                                        fit: pw.BoxFit.contain),
                                    pw.SizedBox(height: 2),
                              ...
                              pw.Column(
                                  crossAxisAlignment:
                                      pw.CrossAxisAlignment.center,
                                  children: [
                                    pw.Image(pw.MemoryImage(widget.surroundin4),
                                        height: 150,
                                        width: 700,
                                        fit: pw.BoxFit.contain),
                                    pw.SizedBox(height: 2),
                            ...
                            children: [
                              pw.Column(
                                  crossAxisAlignment:
                                      pw.CrossAxisAlignment.center,
                                  children: [
                                    pw.Image(pw.MemoryImage(widget.surroundin5),
                                        height: 150,
                                        width: 700,
                                        fit: pw.BoxFit.contain),
                                    pw.SizedBox(height: 2),
                              ...
                              pw.Column(
                                  crossAxisAlignment:
                                      pw.CrossAxisAlignment.center,
                                  children: [
                                    pw.Image(pw.MemoryImage(widget.surroundin6),
                                        height: 150,
                                        width: 700,
                                        fit: pw.BoxFit.contain),
                                    pw.SizedBox(height: 2),
                    ...
                    pw.Row(children: [
                          ...
                          child: pw.Container(
                              ...
                              decoration: pw.BoxDecoration(
                                border: pw.Border(
                                  top: pw.BorderSide(),
                                  left: pw.BorderSide(),
                                  right: pw.BorderSide(color: PdfColors.white),
                                  bottom: pw.BorderSide(color: PdfColors.white),
                                ),
                              ),
                              child: pw.Center(child: pw.Text("Parcel")))),
                      pw.Expanded(
                          flex: 4,
                          child: pw.Container(
                              height: 30,
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Container(
                              ...
                              child: pw.Center(child: pw.Text("Sixe (sqm)")))),
                      pw.Expanded(
                          flex: 6,
                          child: pw.Container(
                              height: 30,
                              ...
                              child: pw.Center(
                                  child: pw.Text("Subject Value in USD / sqm",
                                      style: pw.TextStyle(),
                                      textAlign: pw.TextAlign.center)))),
                      pw.Expanded(
                          flex: 3,
                          child: pw.Container(
                              ...
                              child: pw.Center(child: pw.Text("Price / USD")))),
                      pw.Expanded(
                          flex: 4,
                          child: pw.Container(
                              height: 30,
                              ...
                              child: pw.Center(child: pw.Text("Total Price"))))
                    ]),
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.Container(
          ...
          child: pw.Padding(
              padding: const pw.EdgeInsets.only(top: 10, left: 15, right: 15),
              child: pw.Column(
                // mainAxisAlignment: pw.MainAxisAlignment.start,
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Padding(
                    ...
                    child: pw.Text('Google Location of Comparable Property',
                        style: header2(true), textAlign: pw.TextAlign.start),
                  ),
                  pw.Expanded(
                    child: pw.Container(
                          ...
                          pw.Expanded(
                            ...
                            child: pw.Container(
                              decoration: pw.BoxDecoration(
                                  ...
                                  image: pw.DecorationImage(
                                      image: pw.MemoryImage(widget.pImage),
    ...
    //Page Seventeen
//// ឆែកមើលBorder និង តម្លៃរបស់Fire
    pdf.addPage(
      pw.MultiPage(
        maxPages: 1,
        margin: pw.EdgeInsets.all(0.4),
        ...
        build: (context) => [
          ...
          pw.Container(
            ...
            child: pw.Center(
              child: pw.Padding(
                  padding:
                      const pw.EdgeInsets.only(top: 20, left: 15, right: 15),
                  child: pw.Padding(
                      padding:
                          pw.EdgeInsets.only(left: 15, bottom: 50, right: 15),
                      child: pw.Column(
                        // mainAxisAlignment: pw.MainAxisAlignment.start,
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: [
                                  ...
                                  pw.Expanded(
                                    ...
                                    child: pw.Column(
                                      ...
                                      children: [
                                        ...
                                        if (widget
                                                .objProvisional!.land!.length >=
                                            1)
                                          for (int i = 0;
                                              i <
                                                  widget.objProvisional!.land!
                                                      .length;
                                              i++)
                                            pw.Row(
                                                mainAxisAlignment:
                                        ...
                                        if (widget.objProvisional!.building!
                                                .length >=
                                            1)
                                          pw.Row(
                                              mainAxisAlignment:
                                ...
                                pw.Expanded(
                                  ...
                                  child: pw.Container(
                                    ...
                                    child: pw.Center(
                                      child: pw.Text(
                                        numformat.format(
                                          double.parse(widget.objProvisional!
                                                  .totallandvaluemin
                                                  .toString()) +
                                              double.parse(widget
                                                  .objProvisional!
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.Container(
          ...
          child: pw.Column(
            children: [
              pw.Text('Final Indication of Subject Property Market Value',
                  style: header1(), textAlign: pw.TextAlign.center),
              pw.SizedBox(height: 20),
              pw.RichText(
                text: pw.TextSpan(
                  ...
                  children: [
                    ...
                    if (widget.objCover!.header ==
                        "Property [LAND AND BUILDING] VALUATION REPORT") ...[
                      pw.TextSpan(
                          text: ' [Land and Building] ', style: b_body()),
                    ] else if (widget.objCover!.header ==
                        "Property LAND VALUATION REPORT") ...[
                      pw.TextSpan(text: ' [Land] ', style: b_body()),
                    ] else if (widget.objCover!.header ==
                        "Property OFFICE SPACE VALUATION REPORT") ...[
                      pw.TextSpan(text: ' [Office Space] ', style: b_body()),
                    ] else ...[
                      pw.TextSpan(text: ' [Condo] ', style: b_body()),
                    ],
                    pw.TextSpan(
                      text: ' that is the subject of this report.  ',
                      style: body(),
                    ),
                  ],
                ),
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Container(
                              ...
                              decoration:
                                  pw.BoxDecoration(border: pw.Border.all()),
                              child: pw.Center(
                                  child: pw.Text("Property Value USD/Sqm",
                                      style: pw.TextStyle(fontSize: 10))))),
                      pw.Expanded(
                          flex: 6,
                          child: pw.Container(
                                  ...
                                  pw.Expanded(
                                      ...
                                      child: pw.Container(
                                          ...
                                          decoration: pw.BoxDecoration(
                                              border: pw.Border.all()),
                                          child: pw.Center(
                                              child: pw.Text("A.Land")))),
                                ]),
                            if (widget.objFinalIndication!.land!.length >= 1)
                              for (int i = 0;
                                  i < widget.objFinalIndication!.land!.length;
                                  i++)
                                pw.Row(
                                    mainAxisAlignment:
                                        pw.MainAxisAlignment.center,
                                  ...
                                  pw.Expanded(
                                      ...
                                      child: pw.Container(
                                          ...
                                          decoration: pw.BoxDecoration(
                                              border: pw.Border.all()),
                                          child: pw.Center(
                                              child: pw.Text("B.Building")))),
                                ]),
                            if (widget.objFinalIndication!.building!.length >=
                                1)
                              for (int i = 0;
                                  i <
                                      widget
                                          .objFinalIndication!.building!.length;
                                  i++)
                                pw.Row(
                                    mainAxisAlignment:
                                        pw.MainAxisAlignment.center,
                                      ...
                                      children: [
                                        ...
                                        pw.Expanded(
                                          ...
                                          child: pw.Container(
                                            ...
                                            child: pw.Center(
                                              child: pw.Text(officespaceinword,
                                                  style: pw.TextStyle(
                                                    color: PdfColors.red,
                                                    fontSize: 10,
                                                    decoration: pw
              ...
              pw.Padding(
                  ...
                  child: pw.Row(
                      ...
                      children: [
                        pw.Row(children: [
                          pw.Text('Issue Date: ', style: header2(true)),
                          pw.Text('${widget.objFinalIndication!.issus_date}',
                              style: header2(false))
                        ]),
                        pw.Row(children: [
                          pw.Text('Expiry Date: ', style: header2(true)),
                          pw.Text('${widget.objFinalIndication!.expiry_date}',
                              style: header2(false))
                        ])
                      ])),
            ],
    ...
    pdf.addPage(pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.Container(
          height: 720,
          margin: const pw.EdgeInsets.only(top: 5, left: 25, right: 25),
          decoration: pw.BoxDecoration(
              // border: pw.Border.all(
              //   color: PdfColors.black,
              //   width: 1, // Adjust border width as needed
          ...
          child: pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 10),
              pw.Text('CVEA & Professional Indemnity Insurance Certificate',
                  style: header1(), textAlign: pw.TextAlign.center),
              pw.SizedBox(height: 10),
              pw.Expanded(
                flex: 2,
                child: pw.Container(
                    margin: const pw.EdgeInsets.only(top: 3, bottom: 25),
                    decoration: pw.BoxDecoration(
                      border: pw.Border.all(
                        color: PdfColors.black,
                        width: 1,
                        ...
                        children: [
                          pw.Container(
                            decoration: pw.BoxDecoration(
                                ...
                                image: pw.DecorationImage(
                                    image: pw.MemoryImage(certi1Image))),
                          ),
                          pw.Container(
                            decoration: pw.BoxDecoration(
                                border: pw.Border.all(
                                ...
                                image: pw.DecorationImage(
                                    image: pw.MemoryImage(certi2Image),
                                    fit: pw.BoxFit.contain)),
                          ),
                        ])),
              ),
                        ...
                        children: [
                          ...
                          pw.Container(
                            decoration: pw.BoxDecoration(
                                ...
                                image: pw.DecorationImage(
                                    image: pw.MemoryImage(DoungImage))),
                          ),
                          pw.Container(
                            decoration: pw.BoxDecoration(
                                border: pw.Border.all(
                                ...
                                image: pw.DecorationImage(
                                    image: pw.MemoryImage(nullImage))),
                          ),
                          pw.Container(
                            decoration: pw.BoxDecoration(
                                border: pw.Border.all(
                                ...
                                image: pw.DecorationImage(
                                    image: pw.MemoryImage(null1Image))),
                          ),
                        ])),
              ),
            ],
